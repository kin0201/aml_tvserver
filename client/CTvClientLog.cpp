...
int _log_print(const char *moudle_tag, const char *level_tag, const char *class_tag, const char *fmt, ...)
{
    ...
    sprintf(timeBuf, "%04d-%02d-%02d %02d:%02d:%02d:%03d", nowTime.tm_year + 1900, nowTime.tm_mon+1, nowTime.tm_mday,
